...
class NotificationAdapter : ListAdapter<Notification,
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemListNotifikasiBinding.inflate(LayoutInflater.from(parent.context),
            parent, false)
    ...
    inner class NotificationViewHolder(val binding : ItemListNotifikasiBinding) :
        RecyclerView.ViewHolder(binding.root){
            fun bind(data : Notification){
                val backgroundColor = MaterialColors.getColor(binding.root.rootView, com.google.android.material.R.attr.colorPrimaryContainer)
